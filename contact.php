  ...
  <section class="container">
    ...
    <div class="row side-margin border" id="contact">
      <div class="col-lg-6 col-xs-12" id="address">
        ...
        <br />
        <h3>MIPoPS is located on third floor of Seattle City Hall at:</h3>
        <p><i>Seattle City Hall Suite 300<br />600 Fourth Ave.<br />Seattle, WA 98104</i></p>
        <br />
        <h3>Here is our mailing address:</h3>
        <p><i>Moving Image Preservation of Puget Sound<br />2442 NW Market St., #183<br />Seattle, WA 98107</i></p>
        <br />
        <br />
        <p>Our phone number is <i>(310)499-3487</i></p>
      </div>
