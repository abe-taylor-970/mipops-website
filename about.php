...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-xs-12 border members hidden-small2">
        <h1>Anna Briggs</h1>
        <a href= "http://www.univ-tours.fr/" class="left">
          <img src="img/universite_de_tours_cropped.png" alt="Universite De Tours, France" class="img-responsive"/>
        </a>
        <img src="img/bios/anna_briggs_cropped.jpg" alt="Anna Briggs" class="right hidden-small3">
