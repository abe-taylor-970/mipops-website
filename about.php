...
<html>
  ...
  <body>
    ...
    <div class="spacing"></div>
      ...
      <br />
      <h3>Mission:</h3>
      <h4><?php include "_/php/mission.php"; ?></h4>
      <br />
      ...
      <br />
      <p>MIPoPS can work with a variety of videotape formats including ¾” Umatic, VHS, Betacam (SP and Digital), MiniDV, 1”, and DVCam. Using the MIPOPS video transfer station, users can create a preservation-quality digital file (ffv1 format, recognized by moving image archivists) and an access copy (mp4).  MIPOPS will advise on maintaining the original material as well as the newly created digital files. Participants will be asked to have at least one migrated video posted to the MIPoPS Internet Archive site.</p>
      <br />
      <p>MIPoPS founding consortium members are Rachel Price (Executive Director, MIPoPS), Anne Frantilla (Deputy City Archivist, Seattle Municipal Archives), Carol Shenk (County Archivist, King County Archives), and Hannah Palin (Film Archives Specialist, UW Libraries, Special Collections).</p>
      </div>
    </div><!-- container -->
